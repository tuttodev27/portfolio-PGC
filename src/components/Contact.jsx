  ...
  return (
    <section id="contact" className="section-base">
      <div className="container-max">
        ...
        {/* Layout — apilado en móvil, lado a lado en md+ */}
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.8fr] gap-8 md:gap-10">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <a href="https://www.linkedin.com/in/pablo-alexis-gallegos-celis/" target="_blank" rel="noopener noreferrer" className="text-white/60 text-xs hover:text-blue-400 transition-colors break-all">
                      /in/pablo-alexis-gallegos-celis
                    </a>
                  </div>
                </div>

                {/* GitHub — FIX: link correcto */}
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-slate-800 border border-slate-700 rounded-lg flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-blue-400/70" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/tuttodev27" target="_blank" rel="noopener noreferrer" className="text-white/60 text-xs hover:text-blue-400 transition-colors">
                      github.com/tuttodev27
                    </a>
                  </div>
                </div>
          ...
          {/* Formulario */}
          <div className="bg-slate-900/50 border border-slate-700 rounded-2xl p-5 md:p-6">
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center text-center py-10">
                ...
                <button onClick={() => setStatus("idle")} className="text-xs font-mono text-blue-400/60 hover:text-blue-400 transition-colors underline underline-offset-4">
                  Enviar otro mensaje
                </button>
              </div>
            ) : (
